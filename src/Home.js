    ...
    <div className="home">
      <div className="home_container">
        ...
        <div className="home_row">
          <Product 
            id="1211"
            title="Bennett Mystic 15.6 inch Laptop Shoulder Messenger Sling Office Bag, Water Repellent Fabric for Men and Women" price={11.96} rating={5} image="https://images-na.ssl-images-amazon.com/images/I/71mEsHyzSCL._SL1000_.jpg"
